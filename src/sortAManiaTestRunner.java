...
public class sortAManiaTestRunner
{
    public static void main(String[] args)
    {
        ...
        SortingUtil.printArr(randIntArr); //print out the unsorted array

        long time = System.currentTimeMillis(); //start the timer
        int median = team1.challengeOne(ranIntArr); //run your challenge one code
        ...
        SortingUtil.printArr(randIntArr); //check if array was sorted correctly
    }
}
